...
open() {
  assetsAudioPlayer.open(
    Audio("assets/audio/Abhi Toh Party Shuru Hui Hai.mp3"),
  );
}
...
Audio2() {
        ...
        Container(
          ...
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: NetworkImage(
                      'https://github.com/Anuddeeph/Fluttert-Media_player/blob/master/audio%20logo/Abhitho.jpg?raw=true'),
                  fit: BoxFit.cover),
  ...
  return MaterialApp(
    ...
    home: Scaffold(
      appBar: AppBar(title: Text('My Songs'), backgroundColor: Colors.green),
      body: body,
